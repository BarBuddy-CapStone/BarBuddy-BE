                ...
                try
                {
                    ...
                    if (accounts.Any())
                    {
                        ...
                        var fcmNotificationForStaff = new CreateNotificationRequest
                        {
                            ...
                            ImageUrl = bar == null ? null : bar.Images.Split(',')[0],
                            IsPublic = false,
                            Message = $"Đơn đăt chỗ mới với mã đặt chỗ {booking.BookingCode} đã được đặt vào ngày {booking.BookingTime.ToString("dd/MM/yyyy")} lúc {booking.BookingTime.Hours:D2}:{booking.BookingTime.Minutes:D2}.",
